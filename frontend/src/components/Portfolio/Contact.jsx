            ...
            <div className="max-w-6xl mx-auto relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-6xl font-bold tracking-tighter leading-none mb-8 text-slate-900 pb-8">
                            Initiate <br />
                            <span className="text-slate-500 pb-4">Dialogue.</span>
                        </h2>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center gap-6 group">
                                <div className="w-14 h-14 rounded-2xl bg-white/80 backdrop-blur-sm border border-slate-100 flex items-center justify-center text-slate-400 group-hover:text-blue-600 group-hover:border-blue-200 transition-all duration-500 shadow-sm">
                    ...
                    >
                        <div className="bg-white/80 backdrop-blur-md p-10 md:p-14 rounded-[3.5rem] border border-slate-200 shadow-2xl shadow-slate-200/50 relative overflow-hidden group">
                            ...
                            <form className="space-y-8 relative z-10" onSubmit={(e) => e.preventDefault()}>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input type="text" placeholder="Alexander Vance" className="w-full bg-slate-50/50 border border-slate-100 rounded-[2rem] pl-16 pr-8 py-5 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all text-base font-black text-slate-800 placeholder:text-slate-300 shadow-inner" />
                                        </div>
                                    </div>
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input type="email" placeholder="name@org.com" className="w-full bg-slate-50/50 border border-slate-100 rounded-[2rem] pl-16 pr-8 py-5 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all text-base font-black text-slate-800 placeholder:text-slate-300 shadow-inner" />
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        {['INSTITUTIONAL', 'VENTURE', 'STRATEGIC'].map((type) => (
                                            <button
                                                ...
                                                className={`px-8 py-4 rounded-2xl text-[10px] font-black transition-all border tracking-widest ${scale === type
                                                    ? 'bg-slate-900 text-white border-slate-900 shadow-xl shadow-slate-200/50 scale-105'
                                                    : 'bg-white text-slate-400 border-slate-200 hover:border-blue-400/50 hover:text-blue-600'}`}
                                            >
                                                {type}
                                            </button>
                                        ))}
                                ...
                                <div className="space-y-3">
                                    ...
                                    <textarea rows="4" placeholder="Outline your project scope..." className="w-full bg-slate-50/50 border border-slate-100 rounded-[2rem] px-8 py-6 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all text-base font-black text-slate-800 placeholder:text-slate-300 shadow-inner resize-none"></textarea>
                                </div>
