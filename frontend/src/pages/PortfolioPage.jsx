...
const PortfolioPage = () => {
  ...
  return (
    <main className="min-h-screen premium-bg pt-24 pb-12 px-6">
      {/* Hero Section with Background Effects */}
      <section className="py-20 relative overflow-hidden mb-16">
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900/10 via-blue-900/10 to-slate-900/10"></div>
        <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-r from-blue-600/10 to-blue-500/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-l from-blue-500/10 to-blue-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 mb-6 shadow-sm">
              ...
              <span className="text-blue-600 font-semibold uppercase tracking-wider text-sm">Our Portfolio</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 heading-underline active pb-2">
              Enterprise <span className="text-premium-gradient">Success Stories</span>
            </h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                <div className="w-16 h-16 rounded-xl bg-slate-900 flex items-center justify-center mx-auto mb-4 group-hover:bg-blue-600 transition-colors">
            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                ...
                <div className="h-48 bg-blue-50 flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 bg-slate-900 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-white uppercase tracking-tighter">
                    {project.category}
                  </div>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 mb-4 text-xs text-slate-500">
                    <div className="flex items-start gap-2">
                      <span className="material-symbols-outlined text-blue-600 text-sm mt-0.5">error</span>
                      <span><strong className="text-slate-900">Challenge:</strong> {project.challenge}</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="material-symbols-outlined text-blue-500 text-sm mt-0.5">check_circle</span>
                      <span><strong className="text-slate-900">Solution:</strong> {project.solution}</span>
                    </div>
                  </div>
                  ...
                  <Link to={`/case-study/${project.title.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`}>
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="mt-6 w-full bg-slate-900 text-white font-semibold py-3 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 group/button hover:bg-blue-600"
                    >
                      View Case Study
      ...
      <section className="py-20 bg-blue-50/30 rounded-3xl mb-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 heading-underline active inline-block pb-1">Client Success Stories</h2>
      ...
      <section className="py-16 mb-20">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 heading-underline active inline-block pb-1">Technological Excellence</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <h3 className="text-slate-900 font-bold mb-2">{tech.title}</h3>
          ...
          <div className="relative z-10">
            ...
            >
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-slate-900 text-white font-bold h-14 px-8 rounded-full shadow-2xl hover:bg-blue-600 transition-all flex items-center gap-2"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-white text-slate-900 font-semibold h-14 px-8 rounded-full border border-slate-200 transition-all flex items-center gap-2 hover:border-slate-900"
              >
