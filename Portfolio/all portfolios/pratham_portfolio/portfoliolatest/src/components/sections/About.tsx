...
const stats = [
  ...
  { label: 'Worked with Companies', value: 3, suffix: '+' },
];
          ...
          <div>
            ...
            >
              ...
              <p className="text-3xl md:text-5xl font-bold tracking-tighter leading-[1.1] mb-8">
                Blending technical precision with <span className="text-muted">creative</span> innovation to craft scalable, user-centric digital experiences.
              </p>
