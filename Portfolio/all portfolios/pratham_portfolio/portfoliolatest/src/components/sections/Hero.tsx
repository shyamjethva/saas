      ...
      */}
      ...
      <div className="container relative z-20 px-6 mx-auto flex-1 flex flex-col justify-between pt-24">
        ...
        >
          <p className="text-xs md:text-sm font-bold text-black/60 uppercase tracking-[0.3em] leading-tight">
            Flutter and <br />Full Stack Developer
          </p>
        </motion.div>
      ...
      >
        <img
          ...
          className="w-full md:w-auto h-[120vh] md:h-[105vh] object-contain object-bottom drop-shadow-[0_40px_100px_rgba(0,0,0,0.2)] scale-[1.75] md:scale-100 origin-bottom over"
        />
      </motion.div>
