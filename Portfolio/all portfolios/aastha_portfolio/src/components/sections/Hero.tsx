      ...
      */}
      ...
      >
        <img
          ...
          className="w-full md:w-auto h-[120vh] md:h-[105vh] object-contain object-bottom drop-shadow-[0_40px_100px_rgba(0,0,0,0.2)] scale-[1.9] md:scale-95 origin-bottom over"
        />
      </motion.div>
