    ...
    <section className="relative h-screen w-full flex flex-col text-black">
      ...
      */}
      ...
      <motion.div
        ...
        className="absolute bottom-8 md:bottom-4 right-6 md:right-12 flex flex-col items-end gap-10 z-[110]"
      >
      ...
      >
        <img
          ...
          className="w-full md:w-auto h-[120vh] md:h-[105vh] object-contain object-bottom drop-shadow-[0_40px_100px_rgba(0,0,0,0.2)] scale-[1.0] md:scale-100 origin-bottom translate-y-4 md:translate-y-8 lg:translate-y-24"
        />
      </motion.div>
